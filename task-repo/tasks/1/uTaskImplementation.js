...
(function() {
  ...
  Sample = (function(_super) {
    ...
    Sample.prototype.createCategories = function() {
    ...
    Sample.prototype.getTweets = function(error, json) {
    ...
    Sample.prototype.getCategories = function(error, json) {
      if (!error) {
    ...
    Sample.prototype.createOuput = function() {
      var $ul, answers;
    ...
    Sample.prototype.run = function() {
      ...
      this.postData(function(error, data) {
        if (!error) {
          return _this.$runBtn.prop('disabled', true);
        } else {
